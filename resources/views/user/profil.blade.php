            ...
            <form action="{{ route('user.update_profil') }}" class="form-profil" method="post" data-toggle="validator" enctype="multipart/form-data" >
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" id="name" value="{{ $profil->name }}" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="profile_photo_path" class="col-lg-2 col-lg-offset-1 control-label">Foto Profil</label>
                        <div class="col-lg-4">
                            <input type="file" name="profile_photo_path" class="form-control" id="profile_photo_path" 
                            onchange="preview('.show-foto-profil', this.files[0])" >
                            <span class="help-block with-errors"></span>
                            <br>
                            <div class="show-foto-profil">
        ...
        $('.form-profil').validator().on('submit', function (e) {
            if (! e.preventDefault()) {
                ...
                .done(response => {
                    ...
                    $('.show-foto-profil').html(`<img src="{{ url('/') }}${response.profile_photo_path}" }}" width="200">`);
